...
export default function YakusokuGardenPage() {
  const router = useRouter()

  const thread: ChatMsg[] = [
    { author: 'user', text: <>Tell me about Yakusoku Garden.</> },
    {
      author: 'allie',
      lines: [
        <span key="0" className="font-medium text-[#2b2b27]">The obvious pick for your date.</span>,
        <>Outdoor garden lawn, Pacific gardens framing every photo, and a ceremony capacity of up to <span className="font-medium text-[#2b2b27]">300 guests</span>. Right-sized for your celebration with breathing room.</>,
      ],
    },
    {
      author: 'allie',
      lines: [
        <span key="t" className="font-medium text-[#2b2b27]">Allie&apos;s pro tip — the garden glows</span>,
        <>Schedule the cocktail hour for <span className="font-medium text-[#2b2b27]">6:30pm</span>. The garden uplighting and ambient string lights kick in as the sun drops, and the whole space looks transformed by the time guests arrive.</>,
        <>Ask the planner about the koi-pond corner for first looks — most couples miss it.</>,
      ],
    },
    {
      author: 'allie',
      lines: [
        <>Packages start at <span className="font-medium text-[#2b2b27]">$5,000</span>. Tap <span className="font-medium text-[#2b2b27]">Select</span> on the right to lock this venue in, or scroll for couple stories that styled it.</>,
      ],
    },
  ]
  ...
  return (
    <SpaceChatLayout
      thread={thread}
      inputPlaceholder="Ask Allie about Yakusoku Garden…"
      activeStep={3}
      railEyebrow="Venue dossier"
      railTitle="Yakusoku Garden"
    >
    <div className="screen-wrap">
      <div className="mobile-frame flex flex-col bg-[#f5f5f5]">
        ...
        <div className="relative w-full overflow-hidden flex flex-col justify-between" style={{ minHeight: 314 }}>
          ...
          <img src="/assets/venue-yakusoku-garden.png" alt="" className="absolute inset-0 w-full h-full object-cover pointer-events-none" />
        ...
        <div className="bg-black flex flex-col gap-[6px] pb-[22px] pt-[18px] px-[20px]">
          <p className="font-sans font-normal text-[9px] tracking-[1.2px] uppercase text-white">Ocean views · Outdoor lawn</p>
          <p className="font-serif text-[36px] leading-[40px] text-white">Yakusoku Garden</p>
          <div className="flex flex-wrap gap-[6px] py-[16px]">
            {[
              { label: 'Outdoor · Garden lawn', color: '#2b2b27' },
              { label: 'Pacific gardens',        color: '#b67d3d' },
          ...
          <div className="flex justify-end">
            <button
              onClick={() => { sessionStorage.setItem('selectedVenue', 'Yakusoku Garden'); router.push('/packages') }}
        ...
        <div className="flex items-center gap-[10px] justify-center p-[24px]" style={{ background: '#e8e8e8' }}>
          ...
          <p className="font-sans text-[12px] leading-[18px] text-[#585858]" style={{ width: 214 }}>
            <span className="font-medium">24</span>{' brides saved this venue in the last 30 days'}
          </p>
        </div>
        ...
        <div className="px-[24px] pt-[36px]">
          <p className="font-sans font-normal text-base leading-6 text-[#585858]" style={{ maxWidth: 330 }}>
            Yakusoku Garden is ideal for garden ceremonies of up to 300 guests. The lush Pacific gardens frame every photo beautifully — and the evening lighting transforms the space into something truly magical.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-[14px] px-[24px] py-[36px]">
          ...
          <div className="flex items-start gap-[12px] pb-[24px]">
            <div className="flex-1 flex flex-col items-center gap-[4px]">
              <p className="font-serif text-[24px] leading-[36px] text-[#2b2b27] whitespace-nowrap">300</p>
            ...
            <div className="flex-1 flex flex-col items-center gap-[4px]">
              <p className="font-serif text-[24px] leading-[36px] text-[#2b2b27] whitespace-nowrap">$4,500</p>
              <div className="text-center">
        ...
        <div className="flex flex-col gap-[14px] p-[24px]" style={{ background: '#585858' }}>
          ...
          <p className="font-sans font-normal text-base leading-6 text-white">
            Schedule your ceremony for golden hour — around 5:45pm. The garden faces west and the Pacific breeze drops right around then. Your guests will remember the air as much as the vows. Ask your florist to lean into the natural greens here; competing with this garden is the wrong fight.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-[14px] py-[36px]">
          ...
          <div className="flex gap-[16px] pl-[24px] overflow-x-auto scroll-x">
            ...
            >
              ...
              <div className="flex flex-col gap-[12px] p-[12px]">
                <div className="flex flex-col gap-[3px]">
                  <p className="font-display font-normal text-[14px] leading-[18px] text-[#2b2b27] tracking-[-0.1px] whitespace-nowrap">Priya + Rahul</p>
            ...
            >
              ...
              <div className="flex flex-col gap-[12px] p-[12px]">
                <div className="flex flex-col gap-[3px]">
                  <p className="font-display font-normal text-[14px] leading-[18px] text-[#2b2b27] tracking-[-0.1px] whitespace-nowrap">Sofia + James</p>
